...
func NewService(settingSvc setting.SettingService, bus *event.EventBus) *Service {
	...
	policy.AllowAttrs("xmlns", "width", "height", "viewBox", "fill", "stroke", "stroke-width", "stroke-linecap", "stroke-linejoin", "preserveAspectRatio", "aria-roledescription", "role", "style", "xmlns:xlink", "id").OnElements("svg")
	policy.AllowAttrs("cx", "cy", "r").OnElements("circle")
	policy.AllowAttrs("d", "style", "class", "marker-end").OnElements("path")
