        ...
        "/public/articles/by-url": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "文章页面URL路径，例如 /posts/abc123 或完整URL",
                        "name": "url",
                        "in": "query",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "config_handler.CreateBackupRequest": {
            ...
            "properties": {
                ...
                "is_auto": {
                    "description": "是否自动备份（可选，用于在列表中显示「自动」标签）",
                    "type": "boolean"
                }
            }
        },
        ...
        "model.Page": {
            ...
            "properties": {
                ...
                "custom_css": {
                    "description": "页面自定义CSS",
                    "type": "string"
                },
                "custom_js": {
                    "description": "页面自定义JavaScript",
                    "type": "string"
                },
                "description": {
                    "description": "页面描述",
        ...
        "model.View": {
            ...
            "properties": {
                "columns": {
                    "description": "omitempty: 如果前端请求中没有这个字段，则忽略，不会导致校验失败。\ndive: 如果有这个字段且是数组，gin会深入到数组内部对每个元素进行校验（如果需要的话）。",
                    "type": "array",
                    "items": {
