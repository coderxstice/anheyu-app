// internal/app/service/article/service.go
package article
...
type Service struct {
	...
	directLinkSvc    *direct_link.DirectLinkService
}

// NewService 是 Article Service 的构造函数。
func NewService(
	repo repository.ArticleRepository,
	postTagRepo repository.PostTagRepository,
	postCategoryRepo repository.PostCategoryRepository,
...
func (s *Service) UploadArticleImage(ctx context.Context, ownerID uint, fileReader io.Reader, originalFilename string) (string, error) {
...
// 从图片URL获取主色调的私有辅助函数
func (s *Service) getPrimaryColorFromImageURL(ctx context.Context, imageURL string) (string, error) {
...
// 封装了确定并获取主色调的逻辑
func (s *Service) determinePrimaryColor(ctx context.Context, topImgURL, coverURL string) string {
...
func (s *Service) updateSiteStatsInBackground() {
	go func() {
...
func (s *Service) ToAPIResponse(a *model.Article, useAbbrlinkAsID bool, includeHTML bool) *model.ArticleResponse {
	if a == nil {
		return nil
	}
...
func (s *Service) getCacheKey(publicID string) string {
	return fmt.Sprintf("article:html:%s", publicID)
}

// GetPublicBySlugOrID 为公开浏览，通过 slug 或 ID 获取单篇文章，并处理浏览量。
func (s *Service) GetPublicBySlugOrID(ctx context.Context, slugOrID string) (*model.ArticleDetailResponse, error) {
...
func (s *Service) Create(ctx context.Context, req *model.CreateArticleRequest, ip string) (*model.ArticleResponse, error) {
...
// Get 根据公共ID检索单个文章。
func (s *Service) Get(ctx context.Context, publicID string) (*model.ArticleResponse, error) {
...
func (s *Service) getArticleViewCacheKey(publicID string) string {
	return fmt.Sprintf("article:view_count:%s", publicID)
}

// GetPublicByID (此方法似乎与 GetPublicBySlugOrID 功能重叠，暂时保留)
func (s *Service) GetPublicByID(ctx context.Context, publicID string) (*model.ArticleResponse, error) {
...
// Update 处理更新文章的业务逻辑。
func (s *Service) Update(ctx context.Context, publicID string, req *model.UpdateArticleRequest, ip string) (*model.ArticleResponse, error) {
...
// List 检索分页的文章列表。
func (s *Service) List(ctx context.Context, options *model.ListArticlesOptions) (*model.ArticleListResponse, error) {
...
// GetRandom 获取一篇随机文章。
func (s *Service) GetRandom(ctx context.Context) (*model.ArticleResponse, error) {
...
// ListHome 获取首页推荐文章列表。
func (s *Service) ListHome(ctx context.Context) ([]model.ArticleResponse, error) {
...
func (s *Service) ListPublic(ctx context.Context, options *model.ListPublicArticlesOptions) (*model.ArticleListResponse, error) {
...
func (s *Service) ListArchives(ctx context.Context) (*model.ArchiveSummaryResponse, error) {
