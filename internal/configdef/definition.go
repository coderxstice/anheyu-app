...
var AllSettings = []Definition{
	...
	{Key: constant.KeySiteKeywords, Value: "安和鱼,相册,图片管理", Comment: "站点关键词", IsPublic: true},
	{Key: constant.KeySiteDescription, Value: "安和鱼是一个简单易用的图片管理系统，支持多种图片格式和处理方式。", Comment: "站点描述", IsPublic: true},
	...
	// --- Header/Nav 配置 ---
	{Key: constant.KeyHeaderMenu, Value: `[{"title":"文章","items":[{"title":"分类","path":"/categories","icon":"anzhiyu-icon-shapes","isExternal":false},{"title":"标签","path":"/tags","icon":"anzhiyu-icon-tags","isExternal":false},{"title":"文档","path":"https://docs.anheyu.com/","icon":"anzhiyu-icon-book","isExternal":true}]},{"title":"友链","items":[{"title":"友情链接","path":"/link","icon":"anzhiyu-icon-link","isExternal":false},{"title":"宝藏博主","path":"/travelling","icon":"anzhiyu-icon-cube","isExternal":false}]},{"title":"我的","items":[{"title":"小空调","path":"/air-conditioner","icon":"anzhiyu-icon-fan","isExternal":false},{"title":"相册集","path":"/album","icon":"anzhiyu-icon-images","isExternal":false}]},{"title":"关于","items":[{"title":"随便逛逛","path":"/random-post","icon":"anzhiyu-icon-shoe-prints1","isExternal":false},{"title":"关于本站","path":"/about","icon":"anzhiyu-icon-paper-plane","isExternal":false},{"title":"我的装备","path":"/equipment","icon":"anzhiyu-icon-dice-d20","isExternal":false}]}]`, Comment: "主菜单配置 (有序数组结构)", IsPublic: true},
	...
	{Key: constant.KeyHeaderNavMenu, Value: `[{"title":"网页","items":[{"name":"个人主页","link":"https://index.anheyu.com/","icon":"https://index.anheyu.com/assets/images/avatar.jpg"},{"name":"博客","link":"https://blog.anheyu.com/","icon":"https://upload-bbs.miyoushe.com/upload/2025/08/21/125766904/ff8efb94f09b751a46b331ca439e9e62_2548658293798175481.png"},{"name":"安知鱼图床","link":"https://image.anheyu.com/","icon":"https://upload-bbs.miyoushe.com/upload/2025/08/21/125766904/308b0ee69851998d44566a3420e6f9f2_2603983075304804470.png"}]},{"title":"项目","items":[{"name":"安知鱼主题","link":"https://docs.anheyu.com/","icon":"https://upload-bbs.miyoushe.com/upload/2025/08/21/125766904/6bc70317b1001fe739ffb6189d878bbc_5557049562284776022.png"}]}]`, Comment: "导航栏下拉菜单配置 (结构化JSON)", IsPublic: true},
	{Key: constant.KeyHomeTop, Value: `{"title":"生活明朗","subTitle":"万物可爱。","siteText":"ANHEYU.COM","category":[{"name":"前端","path":"/categories/前端开发/","background":"linear-gradient(to right,#358bff,#15c6ff)","icon":"anzhiyu-icon-dove","isExternal":false},{"name":"大学","path":"/categories/大学生涯","background":"linear-gradient(to right,#f65,#ffbf37)","icon":"anzhiyu-icon-fire","isExternal":false},{"name":"生活","path":"/categories/生活日常","background":"linear-gradient(to right,#18e7ae,#1eebeb)","icon":"anzhiyu-icon-book","isExternal":false}],"banner":{"tips":"新品主题","title":"Theme-AnZhiYu","image":"https://upload-bbs.miyoushe.com/upload/2025/08/21/125766904/00961b9c22d3e633de8294555f3a3375_3621787229868352573.png","link":"https://docs.anheyu.com/","isExternal":true}}`, Comment: "首页顶部UI配置 (JSON格式)", IsPublic: true},
	...
	{Key: constant.KeyFooterProjectList, Value: `[{"title":"服务","links":[{"title":"站点地图","link":"https://blog.anheyu.com/atom.xml"},{"title":"十年之约","link":"https://foreverblog.cn/go.html"},{"title":"开往","link":"https://github.com/travellings-link/travellings"}]},{"title":"主题","links":[{"title":"文档","link":"https://docs.anheyu.com"},{"title":"源码","link":"https://github.com/anzhiyu-c/hexo-theme-anzhiyu"},{"title":"更新日志","link":"/update/"}]},{"title":"导航","links":[{"title":"即刻短文","link":"/essay/"},{"title":"友链文章","link":"/fcircle/"},{"title":"留言板","link":"/comments"}]},{"title":"协议","links":[{"title":"隐私协议","link":"/privacy"},{"title":"Cookies","link":"/cookies"},{"title":"版权协议","link":"/copyright"}]}]`, Comment: "页脚链接列表 (JSON格式)", IsPublic: true},
	{Key: constant.KeyFooterBarLinkList, Value: `[{"link":"https://github.com/anzhiyu-c/hexo-theme-anzhiyu","text":"主题"},{"link":"https://index.anheyu.com","text":"主页"}]`, Comment: "底部栏链接列表 (JSON格式)", IsPublic: true},
	...
	{Key: constant.KeySidebarAuthorStatusImg, Value: "https://upload-bbs.miyoushe.com/upload/2025/08/04/125766904/e3433dc6f4f78a9257060115e339f018_1105042150723011388.png", Comment: "作者卡片状态图片URL", IsPublic: true},
