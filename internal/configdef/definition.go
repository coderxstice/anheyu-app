...
var AllSettings = []Definition{
	...
	{Key: constant.KeyHomeTop, Value: `{"title":"生活明朗","subTitle":"万物可爱。","siteText":"ANHEYU.COM","category":[{"name":"前端","path":"/categories/前端开发/","background":"linear-gradient(to right,#358bff,#15c6ff)","icon":"anzhiyu-icon-dove","isExternal":false},{"name":"大学","path":"/categories/大学生涯","background":"linear-gradient(to right,#f65,#ffbf37)","icon":"anzhiyu-icon-fire","isExternal":false},{"name":"生活","path":"/categories/生活日常","background":"linear-gradient(to right,#18e7ae,#1eebeb)","icon":"anzhiyu-icon-book","isExternal":false}],"banner":{"tips":"新品框架","title":"Theme-AnZhiYu","image":"https://upload-bbs.miyoushe.com/upload/2025/08/21/125766904/00961b9c22d3e633de8294555f3a3375_3621787229868352573.png?x-oss-process=image/format,avif","link":"https://dev.anheyu.com/","isExternal":true}}`, Comment: "首页顶部UI配置 (JSON格式)", IsPublic: true},
	...
	// --- 页面一图流配置 ---
	{Key: constant.KeyPageOneImageConfig, Value: `{"home":{"enable":false,"background":"","mediaType":"image","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false,"videoAutoplay":true,"videoLoop":true,"videoMuted":true},"categories":{"enable":false,"background":"","mediaType":"image","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false,"videoAutoplay":true,"videoLoop":true,"videoMuted":true},"tags":{"enable":false,"background":"","mediaType":"image","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false,"videoAutoplay":true,"videoLoop":true,"videoMuted":true},"archives":{"enable":false,"background":"","mediaType":"image","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false,"videoAutoplay":true,"videoLoop":true,"videoMuted":true}}`, Comment: "页面一图流配置 (JSON格式) - mediaType可选值: image(图片)/video(视频)", IsPublic: true},
