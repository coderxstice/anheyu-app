...
var AllSettings = []Definition{
	...
	// --- 页面一图流配置 ---
	{Key: constant.KeyPageOneImageConfig, Value: `{"home":{"enable":false,"background":"","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false},"link":{"enable":false,"background":"","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false},"categories":{"enable":false,"background":"","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false},"tags":{"enable":false,"background":"","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false},"archives":{"enable":false,"background":"","mainTitle":"安和鱼","subTitle":"生活明朗，万物可爱","typingEffect":false,"hitokoto":false}}`, Comment: "页面一图流配置 (JSON格式)", IsPublic: true},
