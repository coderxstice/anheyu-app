...
var AllSettings = []Definition{
	...
	// --- Header/Nav 配置 ---
	{Key: constant.KeyHeaderMenu, Value: `[{"title":"文章","items":[{"title":"分类","path":"/categories","icon":"anzhiyu-icon-shapes","isExternal":false},{"title":"标签","path":"/tags","icon":"anzhiyu-icon-tags","isExternal":false},{"title":"文档","path":"https://dev.anheyu.com/","icon":"anzhiyu-icon-book","isExternal":true}]},{"title":"友链","items":[{"title":"友情链接","path":"/link","icon":"anzhiyu-icon-link","isExternal":false},{"title":"宝藏博主","path":"/travelling","icon":"anzhiyu-icon-cube","isExternal":false}]},{"title":"我的","items":[{"title":"小空调","path":"/air-conditioner","icon":"anzhiyu-icon-fan","isExternal":false},{"title":"相册集","path":"/album","icon":"anzhiyu-icon-images","isExternal":false}]},{"title":"关于","items":[{"title":"随便逛逛","path":"/random-post","icon":"anzhiyu-icon-shoe-prints1","isExternal":false},{"title":"关于本站","path":"/about","icon":"anzhiyu-icon-paper-plane","isExternal":false},{"title":"我的装备","path":"/equipment","icon":"anzhiyu-icon-dice-d20","isExternal":false}]}]`, Comment: "主菜单配置 (有序数组结构)", IsPublic: true},
